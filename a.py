...
## Divinding data into 16 equal parts
...
for j in range(1,16):
  ...
  ### Bias and Bias sqaure calculation
...
tab1 = pdss.DataFrame(list(zip(index,biAs,bisasq,variance)))
tab1.columns=['Index','Bias','Bias sqaure','Variance']
tab2=pdss.DataFrame(list(zip(index,error)))
